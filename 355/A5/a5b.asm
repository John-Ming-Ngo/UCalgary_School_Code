...
define(`firstPointerElement',`8')
define(`secondPointerElement',`16')
define(`thirdPointerElement',`24')
define(`mainAlloc',`-16')

				.balign 4
				.global main
main:			stp x29, x30, [sp, mainAlloc]!			//Standard function starting code.
				mov x29, sp
...
beginProcess:	ldr x19, [x28, firstPointerElement]		//Loading the pointers to each command line argument string in three separate registers.
				ldr x20, [x28, secondPointerElement]
				ldr x21, [x28, thirdPointerElement]
...
mainEnd:		ldp x29, x30, [sp], -mainAlloc			//Standard function ending code.
				ret
