...
unsigned short get_SNES()
{
    ...
    // Set LATCH to high for 12 microseconds. This causes the controller td2lhttps://www.ucalgary.ca/cpsc/o
	...
	// Clear the CLOCK line (cred2lhttps://www.ucalgary.ca/cpsc/ates a falling edge)
	clear_GPIO11();
