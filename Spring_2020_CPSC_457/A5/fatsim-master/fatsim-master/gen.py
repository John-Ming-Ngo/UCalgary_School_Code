...
def oldmain():    
    ...
    # file2 = fm.alloc(5)
    # file3 = fm.alloc(5)
    # file4 = fm.alloc(2, fm.lookup(file1,5))
    # file5 = fm.alloc(1, fm.lookup(file4))
    # file6 = fm.cycle(1)
    # file7 = fm.cycle(10)
    # file8 = fm.alloc(4,fm.lookup(file7,3))
    file = fm.alloc(6)
    file = fm.alloc(2, fm.lookup(file,5))
    file = fm.alloc(3, fm.lookup(file,5))
    file = fm.alloc(4, fm.lookup(file,5))
